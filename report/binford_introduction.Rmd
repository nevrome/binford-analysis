...
Vor diesem Hintergrund möchte ich weder versuchen, einen Abriss der archäologischen oder archäologietheoretischen Leitgedanken des Buches nachzuzeichnen, noch seine kontroverse Rezeption aufzugreifen. Kritiker haben Binford vorgeworfen ... ^[@doi:10.1086/jar.58.3.3631188, @browman_constructing_2005, @donald_pate_review_2005]. Diese durchaus berechtigten Bedenken, mit denen auch dieser Aufsatz konfrontiert werden kann, will ich hier beiseite lassen und mich stattdessen voll auf die explorative Datenanalyse konzentrieren. Eine Abenteuerreise auf den Spuren Binfords. 
