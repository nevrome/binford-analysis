...
without_na_percent <- without_na/ncol(sel1)
```

Wahrscheinlich wird es sich als sinnvoll erweisen, die Variablen mit äußert geringem Vorkommen aus der Analyse auszuschließen. Immerhin `r without_na` der `r ncol(sel1)` (`r without_na_percent`%) Variablen besitzen überhaupt keine Lehrstellen. Der Datensatz ist bemerkenswert vollständig. 
