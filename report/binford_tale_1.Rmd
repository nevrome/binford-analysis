...
mod_vals %>%
  knitr::kable(
    format = "latex",
    caption = "\\label{tab:binford_model_result_2}Ergebniszusammenfassung des mit Binfords Variablenauswahl reproduzierten Modells für das Gesamtmodell. Alle Werte sind auf drei Nachkommastellen gerundet. \\newline \\textbf{r.squared:} huhu \\newline \\textbf{adj.r.squared:} \\newline \\textbf{std.error:} \\newline \\textbf{sigma:} \\newline \\textbf{statistic} huhu. \\newline \\textbf{p.value} huhu. \\newline \\textbf{df} huhu. \\newline \\textbf{logLik} huhu. \\newline \\textbf{AIC} huhu. \\newline \\textbf{BIC} huhu. \\newline \\textbf{deviance} huhu. \\newline \\textbf{df.residual} huhu. \\protect\\footnotemark{}",
    booktabs = T
  ) %>%
  kableExtra::column_spec(1, bold = TRUE) %>%
