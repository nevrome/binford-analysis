...
Ich habe mich hier für die Implementierung dieses Verfahrens in der Funktion `stepAIC()` des R Pakets MASS^[@venables_modern_2002] entschieden. `stepAIC()` erlaubt ...

Der folgende Codeabschnitt dokumentiert mein Vorgehen:  

```{r stewise multiple regression, echo = TRUE}
