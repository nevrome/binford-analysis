...
Wie im Rahmen der Modellbildung oben angedeutet, ist weder der von Binford noch der von mir applizierte Algorithmus in diesem Kontext zufriedenstellend. Die Vereinfachung des Augangsmodells ist dringend erforderlich, um die wesentlichen Faktoren identifizieren zu können. Dabei führt allerdings die schrittweise Reduktion, wie ich sie durchgeführt habe (und Binford lässt nicht erkennen, dass er dieses Problem besser gelöst hätte) zu einem "Ziehen-ohne-Zurücklegen". Diese selektive Tiefensuche im Baum der Variablenkombinationen kann den Verlust wesentlicher Einflussgrößen zur Konsequenz haben.        
